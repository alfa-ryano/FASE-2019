...
\begin{table}
    ...
    \begin{scriptsize}
        ...
        \begin{tabular}{|c|c|c|c|c|c|c|c|c|c|}
            \hline
            \multirow{2}{*}{\textbf{\makecell{\\No.}}} & \multicolumn{3}{c|}{\textbf{Number of (in millions)}} &  \multicolumn{3}{c|}{\textbf{\makecell{Change-based\\Comparison}}} & \multicolumn{3}{c|}{\textbf{\makecell{State-based\\Comparison}}}\\
            \hhline{~---------}
            & \multicolumn{1}{c|}{\textbf{\makecell{Total\\Events}}} & \multicolumn{1}{c|}{\textbf{\makecell{Total\\Elements}}} & 
            \multicolumn{1}{c|}{\textbf{\makecell{Affected\\Elements}}} & \multicolumn{1}{c|}{\textbf{\makecell{Diffs\\($\times$1m)}}} & \multicolumn{1}{c|}{\textbf{\makecell{Time\\(seconds)}}} & \multicolumn{1}{c|}{\textbf{\makecell{Memory\\(GBs)}}} & \multicolumn{1}{c|}{\textbf{\makecell{Diffs\\($\times$1m)}}} & \multicolumn{1}{c|}{\textbf{\makecell{Time\\(seconds)}}} & \multicolumn{1}{c|}{\textbf{\makecell{Memory\\(GBs)}}} \\ \hline
            1   & 0.11 & 3.25 & 0.12 & 0.08 & 0.60 & 0.29 & 0.08 & 35.19 & 1.60 \\
